"""
A pytorch implementation of GONet without the Temporal Structure
@author Rongfei Lu
"""
...
class Classification(nn.Module):
	""" Classfication Module that consists of FC layers to produce
	...
	def forward(self, img_error, dis_error, dis_output):
		...
		ghf = torch.sigmoid(self.l_FL(con))
		return ghf
